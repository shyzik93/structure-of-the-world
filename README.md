...
Инициализация опирается на предположение (а не факт), что почти невозможно поменять поведение большинство людей разъяснениями и агитацией (человек в этом вообще не заинтересован либо испытывает нехватку времени и трудность следовать новому поведению в старой среде) . Оптимальный вариант — поместить человека в среду, в которой новое повеление станет для него выгодным. Это требует сформировать эту самую среду.
